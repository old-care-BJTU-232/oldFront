<template>
  <div>
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>工作人员信息维护</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="tableData" style="width: 100%"  :default-sort = "{prop: 'state', order: 'descending'}">
        ...
        <el-table-column prop="hire_date" sortable label="入职日期" width="100"></el-table-column>
        <el-table-column prop="resign_date" sortable label="离职日期" width="100"></el-table-column>
        ...
        <div>
          <el-form id="AddDialog" label-position="left" label-width="75px" ref="formRef" :rules="rules" :model="addForm" >
            ...
            <el-form-item label="入职日期" prop="hire_date">
              <el-input v-model="addForm.hire_date" suffix-icon="el-icon-date"></el-input>
            </el-form-item>
            <el-form-item label="离职日期" prop="resign_date">
              <el-input v-model="addForm.resign_date" suffix-icon="el-icon-date"></el-input>
            </el-form-item>
...
<!--              </el-date-picker>-->
            ...
            <el-form-item label="入职日期" prop="hire_date">
<!--              <el-date-picker-->
<!--                      v-model="pointedForm.hire_date"-->
<!--                      align="right"-->
<!--                      type="date"-->
<!--                      placeholder="选择日期"-->
<!--                      :picker-options="pickerOptions">-->
<!--              </el-date-picker>-->
              <el-input v-model="pointedForm.hire_date" suffix-icon="el-icon-date"></el-input>
            </el-form-item>
            <el-form-item label="离职日期" prop="resign_date">
<!--              <el-date-picker-->
<!--                      v-model="pointedForm.resign_date"-->
<!--                      align="right"-->
<!--                      type="date"-->
<!--                      placeholder="选择日期"-->
<!--                      :picker-options="pickerOptions">-->
<!--              </el-date-picker>-->
              <el-input v-model="pointedForm.resign_date" suffix-icon="el-icon-date"></el-input>
            </el-form-item>
            <el-form-item label="简述" prop="DESCRIPTION">
...
<script>
  export default {
    ...
    methods: {
      async getAllInfo () {
        const result = await this.$get('employee/findAll')
        if (result.success === true) {
          ...
          this.tableData.forEach(item=>{
            ...
            if(item.hire_date!=null){
              item.hire_date=item.hire_date.substring(0,10);
            }
            if(item.resign_date!=null){
              item.resign_date=item.resign_date.substring(0,10);
            }
          })
      ...
      async modifySubmit () {
        const result = await this.$post('employee/update', this.pointedForm)
        if (result.success === true) {
      ...
      async addSubmit () {
        ...
        const result = await this.$post('employee/add', this.addForm)
        if (result.success === true) {
      ...
      async deleteSubmit () {
        const result = await this.$get('employee/delete', {
